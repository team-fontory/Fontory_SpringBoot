...
public class AmazonS3BucketService implements CloudStorageService {
    ...
    public FileMetadata uploadProfileImage(FileCreate request, String key) {
        log.info("Uploading profile image: fileName={}, contentType={}, size={} bytes, key={}", 
        ...
        log.info("Profile image uploaded successfully: key={}, bucket={}", key, profileImageBucketName);
    ...
    public String getFileUrl(FileMetadata fileMetadata, String key) {
        ...
        log.debug("Generating file URL: fileType={}, key={}, bucket={}", 
    ...
    public FileMetadata uploadFontTemplateImage(FileCreate request) {
        ...
        log.info("Uploading font template image: fileName={}, contentType={}, fileType={} bytes, key={}",
        ...
        log.info("Font template image uploaded successfully: key={}, bucket={}", key, fontPaperBucketName);
        return result;
    }
    ...
    private AmazonS3ObjectMetadata uploadFile(AmazonS3PutRequest amazonS3PutRequest) {
        ...
        try {
            log.debug("Sending request to S3: bucket={}, key={}, contentType={}", 
            ...
            log.debug("S3 upload completed for key: {}", amazonS3PutRequest.getKey());
        } catch (Exception e) {
